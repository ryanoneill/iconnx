...
pub use layout::{
    ...
    gpu_scatter_nd, gpu_shape, gpu_slice_contiguous, gpu_slice_nd, gpu_split, gpu_tile,
    gpu_transpose_2d, gpu_transpose_nd, gpu_where, ResizeCoordMode, ResizeMode, ResizeNearestMode,
};
