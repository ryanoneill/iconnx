/// GreaterOrEqual operator for Iconnx
///
/// Element-wise x >= y comparison
/// ONNX spec: https://onnx.ai/onnx/operators/onnx__GreaterOrEqual.html
use crate::tensor::Tensor;

/// GreaterOrEqual operator - element-wise comparison
...
impl GreaterOrEqual {
    ...
    pub fn forward(
        ...
        assert_eq!(inputs.len(), 2, "GreaterOrEqual requires exactly 2 inputs");
