/// Greater operator for Iconnx
///
/// Element-wise x > y comparison
/// ONNX spec: https://onnx.ai/onnx/operators/onnx__Greater.html
use crate::tensor::Tensor;

/// Greater operator - element-wise comparison
pub struct Greater;
...
impl Greater {
    ...
    pub fn forward(
        ...
        assert_eq!(inputs.len(), 2, "Greater requires exactly 2 inputs");
